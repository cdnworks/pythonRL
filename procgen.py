...
# Difficulty settings per floor of the dungeon
# First number is the floor number, the second is the max number of the thing
max_items_by_floor = [
    (1, 1),
    (4, 2),
]
...
item_chances: Dict[int, List[Tuple[Entity, int]]] = {
    ...
    4: [(entity_factories.lightning_scroll, 35)],
    6: [(entity_factories.fireball_scroll, 35)],
}
...
def place_entities(
    ...
    # Generate a number of actors per room on a room by room basis
