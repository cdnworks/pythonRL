...
def place_entities(
    ...
    for i in range(number_of_monsters):
        ...
        if not any(entity.x == x and entity.y == y for 
            entity in dungeon.entities):
            if random.random() < 0.8:
                pass # Make an orc here
                entity_factories.orc.spawn(dungeon, x, y)
            else:
                pass # make a troll here
    ...
    for i in range(number_of_items):
        ...
        if not any(entity.x == x and entity.y == y for entity in dungeon.entities):
            ...
            #One day, implement some kind of item drop table here
            if item_chance < 0.7:
